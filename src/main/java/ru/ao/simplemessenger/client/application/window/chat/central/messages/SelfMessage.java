...
public class SelfMessage extends GridPane implements DefaultMessage {
    private final String username;
    private final String text;
    private final String time;

    public SelfMessage(String username, String text, String time) {
        super();
        ...
        NodeFactory.decorateSelfMessage(this);
        ...
        timeLabel.getStyleClass().add("self-message-time-label");
